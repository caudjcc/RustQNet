# -*- coding: utf-8 -*-
"""
Created on Tue Sep 12 09:05:23 2023
...
def get_laplacian_loss(predict, alpha):
	weighted = torch.zeros(alpha.shape).cuda()
	weighted[alpha >= 0.1] = 1
	alpha_f = alpha.clone()*weighted
