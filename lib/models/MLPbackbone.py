...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            print("Load backbone mit_b0 weights")
            self.load_state_dict(torch.load("/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/mit_b0.pth"), strict=False)
...
class mit_b1(MixVisionTransformer):
    def __init__(self, pretrained=False):
        super(mit_b1, self).__init__(
            ...
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone mit_b1 weights")
            self.load_state_dict(torch.load("/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/mit_b1.pth"), strict=False)
...
class mit_b2(MixVisionTransformer):
    def __init__(self, pretrained=False):
        super(mit_b2, self).__init__(
            ...
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone mit_b2 weights")
            self.load_state_dict(torch.load("/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/mit_b2.pth"), strict=False)
...
class mit_b3(MixVisionTransformer):
    def __init__(self, pretrained=False):
        super(mit_b3, self).__init__(
            ...
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone mit_b3 weights")
            self.load_state_dict(torch.load("/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/mit_b3.pth"), strict=False)
...
class mit_b4(MixVisionTransformer):
    def __init__(self, pretrained=False):
        super(mit_b4, self).__init__(
            ...
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone mit_b4 weights")
            self.load_state_dict(torch.load("/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/mit_b4.pth"), strict=False)
...
class mit_b5(MixVisionTransformer):
    def __init__(self, pretrained=False):
        super(mit_b5, self).__init__(
            ...
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone mit_b5 weights")
            self.load_state_dict(torch.load("/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/mit_b5.pth"), strict=False)