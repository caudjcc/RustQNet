...
"""
model_urls = {
    'hrnet18': "/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/hrnetv2_w18_imagenet_pretrained.pth",
    'hrnet32': "/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/hrnetv2_w32_imagenet_pretrained.pth",
    'hrnet48': "/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/hrnetv2_w48_imagenet_pretrained.pth",
    #'hrnet48': "/mnt/sda/dengjie/HRNet-Semantic-Segmentation-HRNet-OCR/pretrain/hrnet_cs_8090_torch11.pth",
}
...
def _hrnet(arch, pretrained, progress, **kwargs):
    try:
        ...
        print("not find MODEL_CONFIGS from ..config.hrnet_config")
    model = HighResolutionNet(MODEL_CONFIGS[arch], **kwargs)
    if pretrained:
        #model_url = model_urls[arch]
        #state_dict = load_state_dict_from_url(model_url, progress=progress)
        state_dict = torch.load(model_urls[arch])
        logger.info( '=> loading {} in pretrained model'.format(arch))
