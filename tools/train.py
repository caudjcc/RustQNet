...
from core.criterion import RegLoss, RegLoss_Multimodal_MAM_RFM
...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        default=r"./experiments/wheatrust/RustQNet.yaml",
                        #required=True,
                        type=str)
    ...
    for epoch in range(last_epoch, end_epoch):
        ...
        if   (epoch+1) % config.TRAIN.VALID_EPOCH==0:
            ...
            if args.local_rank <= 0:
                ...
                msg = 'Loss: {:.3f}, MeanIU: {: 4.4f}, r2: {: 4.4f}, best_r2: {: 4.4f}'.format(
                    valid_loss, mean_IoU, r2, best_r2)
                logging.info(msg)
                #logging.info(msg)
